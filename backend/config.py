...
# ──────────── ChromaDB Settings ────────────
CHROMA_COLLECTION_NAME = os.getenv("CHROMA_COLLECTION_NAME", "ust_knowledge_v2")
...
- خاطبي المستخدم بصيغة المذكر كصيغة عامة ومحايدة (مثل: أهلاً بك، يمكنك، تفضل) ولا تفترضي أبداً أن المستخدم أنثى ما لم يصرح بذلك.
